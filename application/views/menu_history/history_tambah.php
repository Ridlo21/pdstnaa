<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-12">
				<h1>Penempatan Kamar untuk <?= $data->nama ?></h1>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-12">
			    <form id="form_edit_history">
    				<div class="card card-outline card-teal">
    					...
    					<div class="card-body">
    						<div class="row">
    						    <input type="hidden" name="id_person" value="<?= $data->id_person ?>">
    							<div class="col-sm-3">
    					...
    					<div class="card-footer">
							<button type="button" class="btn btn-sm btn-default bg-danger" onclick="detail('<?= $data->id_person ?>')"><i class="fas fa-reply"></i> Keluar</button>
