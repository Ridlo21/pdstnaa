                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <!--<a href="<?= site_url() ?>../gambar/foto/<?= $data->foto_warna_santri ?>?text=1" data-toggle="lightbox" data-title="SCAN FOTO SANTRI" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/foto/<?= $data->foto_warna_santri ?>?text=1" class="img-fluid mb-2" alt="SCAN FOTO SANTRI" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="<?= site_url() ?>../gambar/wali/<?= $data->foto_wali_santri_warna ?>?text=2" data-toggle="lightbox" data-title="SCAN FOTO WALI SANTRI" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/wali/<?= $data->foto_wali_santri_warna ?>?text=2" class="img-fluid mb-2" alt="SCAN FOTO WALI SANTRI" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            ...
                            <!--<a href="<?= site_url() ?>../gambar/akta/<?= $data->foto_scan_akta ?>?text=4" data-toggle="lightbox" data-title="SCAN AKTA KELAHIRAN" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/akta/<?= $data->foto_scan_akta ?>?text=4" class="img-fluid mb-2" alt="SCAN AKTA KELAHIRAN" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <a href="<?= site_url() ?>../gambar/skck/<?= $data->foto_scan_skck ?>?text=5" data-toggle="lightbox" data-title="SCAN SKCK" data-gallery="gallery">
                                <img src="https://ponpesnaa.net/gambar/skck/<?= $data->foto_scan_skck ?>?text=5" class="img-fluid mb-2" alt="SCAN SKCK" />
                            </a>
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="<?= site_url() ?>../gambar/sukes/<?= $data->foto_scan_ket_sehat ?>?text=6" data-toggle="lightbox" data-title="SCAN KETERANGAN SEHAT" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/sukes/<?= $data->foto_scan_ket_sehat ?>?text=6" class="img-fluid mb-2" alt="SCAN KETERANGAN SEHAT" />
                            <!--</a>-->
                        </div>
                    </div>
                </div>
