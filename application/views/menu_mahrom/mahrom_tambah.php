	...
	<div class="container-fluid">
		<div class="card">
		    <div class="card-header">
		        <h3 class="card-title">
		            <a href="#" id="btn-tambah" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ModalaAdd" data-backdrop="static">
			...
			<div class="card-footer">
				...
				<div class="float-right">
					<form id="form_selesai">
						...
						?>
						<input type="hidden" readonly name="angkatan" value="<?= substr("$santri->tgl_daftar", 0, 4) ?>">
