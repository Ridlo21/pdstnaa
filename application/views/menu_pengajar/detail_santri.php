                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <!--<a href="?text=1" data-toggle="lightbox" data-title="SCAN FOTO SANTRI" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/foto/<?= $data->foto_warna_santri ?>" class="img-fluid mb-2" alt="SCAN FOTO SANTRI" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="?text=2" data-toggle="lightbox" data-title="SCAN FOTO WALI SANTRI" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/wali/<?= $data->foto_wali_santri_warna ?>" class="img-fluid mb-2" alt="SCAN FOTO WALI SANTRI" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="?text=3" data-toggle="lightbox" data-title="SCAN KARTU KELUARGA" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/kk/<?= $data->foto_scan_kk ?>" class="img-fluid mb-2" alt="SCAN KARTU KELUARGA" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="?text=4" data-toggle="lightbox" data-title="SCAN AKTA KELAHIRAN" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/akta/<?= $data->foto_scan_akta ?>" class="img-fluid mb-2" alt="SCAN AKTA KELAHIRAN" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="?text=5" data-toggle="lightbox" data-title="SCAN SKCK" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/skck/<?= $data->foto_scan_skck ?>" class="img-fluid mb-2" alt="SCAN SKCK" />
                            <!--</a>-->
                        </div>
                        <div class="col-sm-4">
                            ...
                            <!--<a href="" data-toggle="lightbox" data-title="SCAN KETERANGAN SEHAT" data-gallery="gallery">-->
                                <img src="https://ponpesnaa.net/gambar/sukes/<?= $data->foto_scan_ket_sehat ?>" class="img-fluid mb-2" alt="SCAN KETERANGAN SEHAT" />
                            <!--</a>-->
                        </div>
                    </div>
                </div>
